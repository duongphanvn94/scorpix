            ...
            <Fluid class="card flex-col md:flex-row gap-8">
                ...
                <div class="mt-6">
                    <FloatLabel variant="on">
                        <Select
                            id="province"
                            v-model="form.current_subscription"
                            :options="props.plans"
                            optionLabel="name"
                            optionValue="id"
                            size="large"
...
const form = useForm({
    ...
    request_key_flag: 0,
    current_subscription: props.shop.current_subscription?.product.id || ''
});
...
const handleUpdate = () => {
    ...
    form.transform((data) => {
        ...
        formData.append('current_subscription', data.current_subscription);
