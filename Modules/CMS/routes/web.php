...
use Modules\CMS\Http\Controllers\DemoShopController;
use Modules\CMS\Http\Controllers\QAController;
...
Route::get('/cms/current-user', [AuthController::class, 'currentUser'])->name('cms.current-user')->middleware('auth:admin');
...
Route::group(['prefix' => 'cms', 'middleware' => ['admin.auth']], function () {
    ...
    Route::group(['prefix' => 'orders'], function () {
        ...
        Route::post('/stripe/unsubscribe', [OrderController::class, 'stripeUnsubscribe'])->name('orders.stripeUnsubscribe');
    ...
    Route::group(['prefix' => 'shops'], function () {
        ...
        Route::get('/contract', [ShopController::class, 'contract'])->name('shops.contract');
    });
    ...
    Route::group(['prefix' => 'demo-shops'], function () {
        Route::get('/index', [DemoShopController::class, 'index'])->name('demo-shops.index');
        Route::get('/create', [DemoShopController::class, 'create'])->name('demo-shops.create');
        Route::post('/store', [DemoShopController::class, 'store'])->name('demo-shops.store');
        Route::get('{demoShop}/edit', [DemoShopController::class, 'edit'])->name('demo-shops.edit');
        Route::put('{demoShop}', [DemoShopController::class, 'update'])->name('demo-shops.update');
        Route::delete('{demoShop}', [DemoShopController::class, 'destroy'])->name('demo-shops.destroy');
    });

    Route::group(['prefix' => 'qa'], function () {
        Route::get('/index', [QAController::class, 'index'])->name('cms.qa.index');
        Route::get('/create', [QAController::class, 'create'])->name('cms.qa.create');
        Route::post('/store', [QAController::class, 'store'])->name('cms.qa.store');
        Route::get('{qa}/show', [QAController::class, 'show'])->name('cms.qa.show');
        Route::get('{qa}/edit', [QAController::class, 'edit'])->name('cms.qa.edit');
        Route::put('{qa}', [QAController::class, 'update'])->name('cms.qa.update');
        Route::delete('{qa}', [QAController::class, 'destroy'])->name('cms.qa.destroy');
        Route::put('{qa}/toggle-status', [QAController::class, 'toggleStatus'])->name('cms.qa.toggle-status');
    });
});
